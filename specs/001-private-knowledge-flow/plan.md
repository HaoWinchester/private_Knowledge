...
**Primary Dependencies**: FastAPI, Pydantic v2, SQLAlchemy async, Alembic, Celery, Redis, pytest for backend; existing frontend uses TanStack Start, TanStack Router, Vite, React 19, React Query, Tailwind CSS, shadcn/Radix UI components, lucide-react, and sonner
...
### Source Code (current backend repository root)
